...
Revision ID: 683bdc6f91b7
Revises: d4de063df517
Create Date: 2021-04-13 16:31:59.466164

"""
from alembic import op

# revision identifiers, used by Alembic.
revision = "683bdc6f91b7"
down_revision = "d4de063df517"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    conn.execute(
        ...
        SELECT 
            ...
            , count(case when os.is_partial = true then 1 else null end) missing_obs
...
def downgrade():
    conn = op.get_bind()
    conn.execute("DROP CREATE MATERIALIZED VIEW agg_observation_sets;")
    conn.execute(
        """
        CREATE MATERIALIZED VIEW agg_observation_sets AS
        SELECT 
